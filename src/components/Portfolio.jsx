      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-14 sm:mb-20">
          ...
          <h2 className="reveal text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-slate-100">
            Мои <span className="text-gradient">последние работы</span>
          </h2>
          <p className="reveal mt-4 text-slate-400 text-base sm:text-lg">
            Каждый проект — реальный лендинг с продуманной структурой, адаптивной вёрсткой и акцентом на конверсию.
          </p>
        </div>
        ...
        <div className="reveal mt-14 sm:mt-20 text-center">
          ...
          >
            <Sparkles size={16} />
            Хотите так же? Обсудим ваш проект
          </a>
        </div>
      </div>
    </section>
